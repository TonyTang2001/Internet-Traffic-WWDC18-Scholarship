...
/*:
 Notice:
 - Run this PlaygroundBook with **Landscape** mode.
 - This Page Contains SoundEffects, 🔊 **Turn up the Volume** 🔊 to Experience.
 - - -
 # HTTP Network Protocal
 
 This PlaygroundBook will teach you about **what HTTP Network Protocal is** and **how HTTP works** when we are browsing websites.
 
 - [HTTP](glossary://HTTP) is the set of rules for transferring [Files](glossary://Files) on the World Wide Web.
 ...
 - **Before** we Click the "Run My Code" Button, the scene on the right is a common Webpage resulted from a [HTTP-Request](glossary://HTTP-Request):" http://apple.com ".
 
 - - -
 
 ## How does HTTP work Technically?
 
 1. User-Device sends out a [HTTP-Request](glossary://HTTP-Request).
 
 2. Server receives User-Device's request.
 
 3. Server sends [Files](glossary://Files) to the User-Device.
 
 4. User-Device receive [Files](glossary://Files).
 
 5. User-Device [Decode](glossary://Decode) Files and Display the Webpage.
...
class MyViewController : UIViewController {
    override func loadView() {
        ...
        datacircleAni(withColor: "Blue", andOrient: 1, startingPointx: 245, startingPointy: 200, withStartDelay: 5)
        ...
        func returnSoundDetail() -> SystemSoundID {
            ...
            let soundURL = CFBundleCopyResourceURL(CFBundleGetMainBundle(), "user&server" as CFString, "m4a" as CFString, nil)
